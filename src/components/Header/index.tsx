...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`ud-header left-0 top-0 z-40 flex w-full items-center border-b border-stroke bg-white/80 backdrop-blur-[5px] dark:border-dark-3/20 dark:bg-dark/10
          ${sticky && "shadow-nav fixed z-[999] "}
          ${!sticky && "absolute"}
        `}
      >
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex-grow flex justify-center">
              <nav
                id="navbarCollapse"
                className={`navbar absolute right-0 z-30 w-[250px] rounded border-[.5px] border-body-color/50 bg-white px-6 py-4 duration-300 dark:border-body-color/20 dark:bg-[#18181a] lg:visible lg:static lg:w-auto lg:border-none lg:!bg-transparent lg:p-0 lg:opacity-100 lg:dark:bg-transparent ${navbarOpen
            ...
            <div className="flex items-center justify-end px-4">
              {/* Theme Toggler dan Sign In/Sign Up */}
              <div className="items-center justify-end flex lg:pr-0">
                {/* theme toggler */}
                <button
              ...
              >
                <span
                  className={`relative my-1.5 block h-0.5 w-[30px] transition-all duration-300 ${navbarOpen ? " top-[7px] rotate-45" : ""} !bg-dark dark:!bg-white`}
                />
                <span
                  className={`relative my-1.5 block h-0.5 w-[30px] transition-all duration-300 ${navbarOpen ? "opacity-0" : ""} !bg-dark dark:!bg-white`}
                />
                <span
                  className={`relative my-1.5 block h-0.5 w-[30px] transition-all duration-300 ${navbarOpen ? " top-[-8px] -rotate-45" : ""} !bg-dark dark:!bg-white`}
                />
              </button>
            </div>
          </div>
